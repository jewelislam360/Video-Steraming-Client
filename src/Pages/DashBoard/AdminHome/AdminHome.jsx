...
const AdminHome = () => {
    ...
    return (
        <>
            <div className=' flex flex-col lg:flex-row gap-3 text-white mt-8'>
                ...
                <div className=" h-40 w-96 bg-slate-600 rounded-xl p-8 text-center">
                    <div className="">
                        ...
                        <div className='flex justify-around items-center'>
                            <h2 className='text-4xl font-extrabold'>76</h2>
...
<div className="ml-auto mb-6 mx-auto ">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="md:col-span-2 lg:col-span-1" >
                <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div>
                        <h5 className="text-xl text-gray-600 text-center">Total Premium User</h5>
...
<path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
                        ...
                        <span className="block text-center text-gray-500">Make to last week $13,988</span>
                    </div>
                    <table className="w-full text-gray-600">
                        <tbody>
                            <tr>
                                <td className="py-2">Action Movie</td>
                            ...
                            <tr>
                                <td className="py-2">Animation Movie</td>
            ...
            <div>
                <div className="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                    <h5 className="text-xl text-gray-700">Viewers</h5>
                    <div className="my-8">
            ...
            <div>
                <div className="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div className="mt-6">
                        <h5 className="text-xl text-gray-700 text-center">Our new viewers</h5>
                        <div className="mt-2 flex justify-center gap-4">
                    ...
                    <table className="mt-6 -mb-2 w-full text-gray-600">
                        <tbody>
                            <tr>
                                <td className="py-2">All movie</td>
                                <td className="text-gray-500">896</td>
                                <td>
                                    <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
