                            ...
                            <div className='lg:flex md:flex flex-1 justify-between items-center px-20'>
                                <div className=' content'>
                                    <div className='mt-24 md:mt-0 lg:mt-0 xl:mt-0' data-aos="fade-down">
                                        ...
                                        <h1 className='movie-title max-w-[250px] text-2xl'>
                                        {doc.title}   
                                        </h1>
                                    </div>
                                    <div data-aos="fade-right">
                                        <h4 className='hidden lg:visible md:visible xl:visible text-gray-300 font-normal text-xl'>
                                            ...
                                            <span><i className=' bg-red-600 text-white px-1 py-1 inline-block rounded-sm'>{doc.like}</i></span>
                                            <span>{doc.time}</span>
                                            <span>{doc.category}</span>
                                        </h4>
                                        <p className=' lg:visible md:visible xl:visible text-xs font-light text-white leading-5 my-5'>{doc.description}</p>
                                ...
                                <div className="flex flex-col justify-end items-center p-4 text-center" data-aos="zoom-in-left">
                                    ...
                                    {/* <video className=' w-[100%] lg:w-2/3 lg:h-2/4 md:w-2/3 md:h-2/4 rounded-lg relative' src={doc.trailer}
                                        muted
                                        controls="true"
                                        light='true'
                                    ></video> */}
                                    <ReactPlayer className='react-player w-[100%] lg:w-2/3 lg:h-2/4 md:w-2/3 md:h-2/4 rounded-lg relative' url={doc.trailer} controls={true} light={doc.img}/>
                                </div>
                            </div>
                        </div>
                    </SwiperSlide>)
