            ...
            <ul className="menu">
              {isAdmin ? (
                <>
                  ...
                  <li>
                    <Link
                      to="/dashboard/addTvShow"
                      className={`${
                        pathname === "/dashboard/addTvShow"
                          ? "text-cyan-50"
                          : "text-orange-500"
                      }`}
                    >
                ...
                <>
                  ...
                  <li>
                    <Link>
                      <FaUsers className="icon" />
                      <span className="nav-item">My Cart</span>
                    </Link>
                  </li>
                  <li>
                    <Link>
                      <FaRegStar className="icon" />
                      <span className="nav-item">Histroy</span>
                    </Link>
                  </li>
                  <li>
                    <Link>
              ...
              <li>
                ...
                >
                  <FaTv className="icon" />
                  <span className="nav-item">Tv-Show</span>
                </Link>
              </li>
              <li>
                <Link
                  to="/dashboard/movieList"
                  className={`${
                    pathname === "/dashboard/additem"
                      ? "text-cyan-50"
                      : "text-orange-500"
                ...
                >
                  <FaThList className="icon" />
                  <span className="nav-item">Movie</span>
                </Link>
              </li>
              <div className="divider"></div>
