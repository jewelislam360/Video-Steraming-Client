...
const Footer = () => {
    return (
        <footer>
            {/* /Top section */}
            <div className="py-10  bg-[#272829] text-white">
                    ...
                    <div>
                        ...
                        <div className='flex gap-2 '>
                            <a href="" target="_blank"
                                className="flex items-center justify-center w-full px-5 py-3 text-center text-white bg-black rounded-2xl sm:rounded-2xl md:w-auto"
                                rel="noreferrer">
